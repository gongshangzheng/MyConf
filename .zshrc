...
alias n-keyd="nvim ~/MyConf/keyd-default.conf"
...
alias e-keyd="emacsclient -n ~/MyConf/keyd-default.conf"
...
export LD_LIBRARY_PATH=/usr/local/cuda-12.8/lib64:/usr/local/lib:$LD_LIBRARY_PATH
